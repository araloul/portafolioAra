...
<div class="container-fluid">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
      ...
      <li class="nav-item">
        <a class="nav-link" id="trabajos" href="trabajos.html">Trabajos</a>
      </li>
      ...
      <div class="icons-container" >
        <a href="https://github.com/araloul" id="github">
      ...
      <a href="" id="linkedin">
        ...
        <!--MAIL-->    
        <a href="mailto:lic.aranzaquijano@gmail.com" target="_blank" id="mail" > 
